...
import { BaseIdentifiableComponent, BaseIdentifiableObject, BaseIdentifier, BaseIdentifierFormat, BaseIdentifierFormats } from "./identifier";
 ...
 * @template T - The type of the instance. It extends BaseInstance.
 */
interface BaseJobObjectInterface
<
    I extends BaseIdentifierFormat = BaseIdentifierFormats.UUID,
    P extends BaseParameters = [],
    R = any,
