...
async function checkForKubeProbe(req: Request, res: Response, next: NextFunction): Promise<any> {
...
const encodeConnection = (req: Request, res: Response, next: NextFunction) => {
...
async function checkPublicApiKey(req: Request, res: Response, next: NextFunction): Promise<any> {
