 ...
 */
declare enum PocketUserAccountStorageTypes {
    FILE = "FILE",
    DIRECTORY = "DIRECTORY",
 ...
 */
declare enum PocketUserAccountContactTypes {
    EMAIL = "EMAIL",
    PHONE = "PHONE",
    ADDRESS = "ADDRESS",
    SOCIAL = "SOCIAL",
...
export { type StringOrEmpty, type PocketUserAccountValue, type PocketUserAccountMetadataAnnotations, type PocketUserAccountMetadataLabels, type PocketUserAccountMetadata, type PocketUserAccountStorage, type PocketUserAccountStorageItem, type PocketUserAccountStorageType, type PocketUserAccount, type PocketUserAccountContact, type PocketUserAccountContactType, type PocketUserAccountVerifiedContact, type PocketUserAccountTimestamps, PocketUserAccountContactTypes, PocketUserAccountStorageTypes };
