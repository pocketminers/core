 ...
 */
interface BaseMetadataLabels<I extends BaseIdentifierType, T extends BaseObjectType> extends Partial<Record<'id', BaseIdentifier<I>>>, Partial<Record<'name', StringOrEmpty>>, Partial<Record<'type', T>>, Partial<Record<'tags', Array<StringOrEmpty>>>, Partial<Record<BaseValueKey, BaseValue>> {
}
/**
 * Metadata contains additional information about the user account, including annotations and labels.
 */
interface BaseMetadata<I extends BaseIdentifierType, T extends BaseObjectType> extends Partial<Record<'annotations', BaseMetadataAnnotations>>, Partial<Record<'labels', BaseMetadataLabels<I, T>>>, Partial<Record<'timestamps', BaseTimestamps>> {
}
/**
 ...
 */
interface BaseMetadataEntry<I extends BaseIdentifierType, T extends BaseObjectType> extends Partial<Record<'id', BaseIdentifier<I>>>, Partial<Record<'type', T>>, Partial<Record<'name', StringOrEmpty>>, Partial<Record<'description', StringOrEmpty>>, Partial<Record<'tags', Array<StringOrEmpty>>>, Partial<Record<'timestamps', BaseTimestamps>>, Partial<Record<'annotations', BaseMetadataAnnotations>>, Partial<Record<'labels', BaseMetadataLabels<I, T>>> {
}
