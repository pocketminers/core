...
exports.MultiHashUtilities = exports.MultiHashAlgorithms = void 0;
...
(function (MultiHashAlgorithms) {
    ...
    //  */
    //  RIPEMD160 = 'RIPEMD160'
})(MultiHashAlgorithms || (exports.MultiHashAlgorithms = MultiHashAlgorithms = {}));
...
class MultiHashUtilities {
    ...
    static async hashStringWithAlgorithm(input, algorithm) {
        if (checks_1.Checks.isEmpty(input)) {
