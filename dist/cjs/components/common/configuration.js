...
const message_1 = require("../base/message.js");
...
class PocketConfiguration extends base_1.Immuteable {
    ...
    addParameter(param) {
        ...
        return new message_1.PocketMessage({
            body: `Parameter ${param.nameString} added to configuration.`,
            code: v0_1.BaseSuccessCodes.OK,
            level: v0_1.BaseMessageLevels.SUCCESS,
        });
    }
    ...
    static getDefaultRequiredParameterValues({ params }) {
        ...
        for (const param of defaultRequiredParams) {
            ...
            if (defaultValue !== undefined
                && checks_1.Checks.isEmpty(defaultValue) === false) {
