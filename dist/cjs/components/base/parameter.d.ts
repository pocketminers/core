...
import { PocketArgumentConfigurationOptions } from "./argument.js";
interface PocketParameterConfigurationOptions extends PocketArgumentConfigurationOptions {
}
interface PocketParameterEntry<T = any> extends Record<"name", BaseValueKey>, Partial<Record<"key", BaseValueKey>>, Partial<Record<"description", string>>, Partial<Record<"default", BaseValue<T>>>, Partial<Record<"required", boolean>>, Partial<Record<"options", BaseValue<T>[]>>, Partial<Record<'configuration', PocketParameterConfigurationOptions>> {
}
/**
 ...
 */
declare class PocketParameter<T = any> extends Immuteable implements BaseParameter<T> {
    /**
     ...
     */
    constructor({ name, key, description, default: defaultValue, required, options, configuration: { freeze, allowEmpty }, }: PocketParameterEntry<T>);
    /**
...
export { type PocketParameterConfigurationOptions, type PocketParameterEntry, PocketParameter };
