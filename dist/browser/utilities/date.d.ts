 ...
 */
import { BaseTimestampEntry } from "../templates/v0/base/timestamps.js";
declare class DateUtilities {
     ...
     */
    static generateISODateString(date?: Date): string;
    /**
     ...
     */
    static generateRFCDateString(date?: Date): string;
    /**
     ...
     */
    static generateUnixTimestampNumber(date?: Date): number;
    /**
     ...
     */
    static generateLocaleDateString(date?: Date): string;
    /**
     * Generate a `Date` object from a UNIX timestamp.
     */
    static generateDateFromUnixTimestamp(unixTimestamp: number): Date;
    /**
     * Generate a Date object from an ISO 8601 formatted string.
     */
    static generateDateFromISODateString(isoDateString: string): Date;
    /**
     * Generate a Date object from an RFC 7231 formatted string.
     */
    static generateDateFromRFCDateString(rfcDateString: string): Date;
    /**
     ...
     */
    static generateDateFromLocaleDateString(localeDateString: string): Date;
    /**
     * Add Years to a date.
     ...
     */
    static addTime(date: Date, time: BaseTimestampEntry): Date;
    /**
     ...
     */
    static subtractTime(date: Date, time: BaseTimestampEntry): Date;
}
