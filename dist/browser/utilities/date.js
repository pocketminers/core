...
var DateUtilities = /** @class */ (function () {
     ...
     */
    DateUtilities.generateISODateString = function (date) {
     ...
     */
    DateUtilities.generateRFCDateString = function (date) {
        if (date === void 0) { date = new Date(); }
     ...
     */
    DateUtilities.generateUnixTimestampNumber = function (date) {
        if (date === void 0) { date = new Date(); }
     ...
     */
    DateUtilities.generateLocaleDateString = function (date) {
        if (date === void 0) { date = new Date(); }
     ...
     */
    DateUtilities.generateDateFromUnixTimestamp = function (unixTimestamp) {
        return new Date(unixTimestamp * 1000);
    };
    /**
     * Generate a Date object from an ISO 8601 formatted string.
     */
    DateUtilities.generateDateFromISODateString = function (isoDateString) {
     ...
     */
    DateUtilities.generateDateFromRFCDateString = function (rfcDateString) {
     ...
     */
    DateUtilities.generateDateFromLocaleDateString = function (localeDateString) {
     ...
     */
    DateUtilities.addYears = function (date, years) {
     ...
     */
    DateUtilities.addMonths = function (date, months) {
        var result = new Date(date);
     ...
     */
    DateUtilities.addWeeks = function (date, weeks) {
        var result = new Date(date);
     ...
     */
    DateUtilities.addDays = function (date, days) {
        var result = new Date(date);
     ...
     */
    DateUtilities.addHours = function (date, hours) {
        var result = new Date(date);
     ...
     */
    DateUtilities.addMinutes = function (date, minutes) {
        var result = new Date(date);
     ...
     */
    DateUtilities.addSeconds = function (date, seconds) {
        var result = new Date(date);
     ...
     */
    DateUtilities.addMilliseconds = function (date, milliseconds) {
        var result = new Date(date);
     ...
     */
    DateUtilities.addTime = function (date, time) {
     ...
     */
    DateUtilities.subtractYears = function (date, years) {
        var result = new Date(date);
        result.setFullYear(result.getFullYear() - years);
        return result;
    };
     ...
     */
    DateUtilities.subtractMonths = function (date, months) {
        var result = new Date(date);
        result.setMonth(result.getMonth() - months);
        return result;
    };
     ...
     */
    DateUtilities.subtractWeeks = function (date, weeks) {
        var result = new Date(date);
        result.setDate(result.getDate() - weeks * 7);
        return result;
    };
     ...
     */
    DateUtilities.subtractDays = function (date, days) {
        var result = new Date(date);
        result.setDate(result.getDate() - days);
        return result;
    };
     ...
     */
    DateUtilities.subtractHours = function (date, hours) {
        var result = new Date(date);
        result.setHours(result.getHours() - hours);
        return result;
    };
     ...
     */
    DateUtilities.subtractMinutes = function (date, minutes) {
        var result = new Date(date);
        result.setMinutes(result.getMinutes() - minutes);
        return result;
    };
     ...
     */
    DateUtilities.subtractSeconds = function (date, seconds) {
        var result = new Date(date);
        result.setSeconds(result.getSeconds() - seconds);
        return result;
    };
     ...
     */
    DateUtilities.subtractMilliseconds = function (date, milliseconds) {
        var result = new Date(date);
        result.setMilliseconds(result.getMilliseconds() - milliseconds);
        return result;
    };
     ...
     */
    DateUtilities.subtractTime = function (date, time) {
        date.setFullYear(date.getFullYear() - (time.years !== undefined ? time.years : 0));
        date.setMonth(date.getMonth() - (time.months !== undefined ? time.months : 0));
        date.setDate(date.getDate() - ((time.weeks !== undefined ? time.weeks : 0) * 7) - (time.days !== undefined ? time.days : 0));
        date.setHours(date.getHours() - (time.hours !== undefined ? time.hours : 0));
