...
var PocketMessage = /** @class */ (function () {
    function PocketMessage(_a) {
        var code = _a.code, level = _a.level, body = _a.body, timestamp = _a.timestamp, data = _a.data, _b = _a.printToConsole, printToConsole = _b === void 0 ? false : _b, callback = _a.callback;
